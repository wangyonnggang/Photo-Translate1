...
package com.apacdtse.recognizer;
...
import com.apacdtse.recognizer.util.Constant;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
   ...
   // private static final List<String> SP_SOURCE_LIST = new ArrayList<>(Arrays.asList("自动检测", "中文", "英文", "法语", "西班牙语", "阿拉伯语", "泰语", "土耳其语"));
    private static final List<String> SP_SOURCE_LIST = new ArrayList<>(Arrays.asList("Auto", "Chinese", "English", "French", "Spanish", "Arabic", "Thai", "Turkish"));
    ...
    private static final List<String> SP_DEST_LIST = new ArrayList<>(Arrays.asList("Chinese", "English", "French", "Spanish", "Arabic", "Thai", "Turkish"));
